<?php
   ...
   if ($_POST) {
   	...
   	$notelp = trim($_POST['phone']);
   	$alamat = trim($_POST['alamat']);
   	$email = trim($_POST['email']);

   	if(isset($_SESSION['items'])) {
   		foreach($_SESSION['items'] as $key => $value) {
   			$kodebrg = $_SESSION['barang'];
   			$kuantitas = $_SESSION['items'][$key];
   			$query = mysqli_query($koneksi, "SELECT * FROM barang WHERE kode_brg = '$kodebrg'");
   			$data = mysqli_fetch_array($query);
   			$hargabrg = $data['harga'];
   			$harga = $hargabrg * $kuantitas;
   	
   			require_once("databases/Database.php");
   			require_once("databases/Transaksi.php");

   			$db = new TransaksiDB();
   			if ($db->insert($kodebrg, $username, $kuantitas, $harga, $nama, $notelp, $alamat, $email)) {
   				header("Location: payment.php");
   				exit();
   			}
   			else
   				echo ("Gagal input transaksi");
   			}
   		}
   	}
?>
...
<head>
	<title>EZShoes | Detail Check Out :: w3layouts</title>
	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
			<div class="privacy about">
				<h3><center>Detail Checkout</center></h3>
				<p><center>Your Shop List</center></p>
				<form method="post" action="detailcheckout.php">
				...
				<div class="col-md-8 address_form">
						<h4>Isi detail dibawah ini untuk alamat pengiriman</h4>
							<section class="creditly-wrapper wrapper">
								<div class="information-wrapper">
									<div class="first-row form-group">
										<div class="controls">
											<label class="control-label">Username: </label>
											<input class="billing-address-name form-control" type="text" name="username" placeholder="Username yang telah terdaftar">
										</div>
										<div class="controls">
											<label class="control-label">Nama: </label>
											<input class="billing-address-name form-control" type="text" name="nama" placeholder="Nama">
										</div>
										<div class="card_number_grids">
											<div class="card_number_grid_left">
												<div class="controls">
													<label class="control-label">No. Telepon:</label>
													<input class="form-control" type="text" name="phone" placeholder="No. Telp">
												</div>
											</div>

<?php
    ...
    require_once("databases/Database.php");
   	...
   	if ($_POST) {
   		...
   		$testimoni = trim($_POST['message']);

   		if ($db->insert($nama, $email, $testimoni)) {
...
<div class="banner_top innerpage" id="home">
	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
			<h3 class="head">Our Testimoni</h3>
			<p class="head_para"></p>
			<div class="inner_section_w3ls">
				<div class="col-md-7 contact_grid_right">
					<h6>Isi testimoni anda disini</h6>
				...
				<div class="col-md-5 contact-left">
					...
					<div class="visit">
						...
						<div class="col-md-10 col-sm-10 col-xs-10 contact-text">
							<h4>Visit us</h4>
							<p>Jalan prancis duta bandara permai blok gs 5 no 15 , Tangerang</p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="mail-us">
						...
						<div class="col-md-10 col-sm-10 col-xs-10 contact-text">
							<h4>Mail us</h4>
							<p><a href=Email :<a href="mailto:@yahoo.com"> ezshoesjkt.cs@yahoo.com</a></p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="call">
		...
		<h3><center>Testimoni dari beberapa customer EZShoesJKT</center></h3>
		<?php
			require_once("databases/Database.php");
			require_once("databases/Testimoni.php");
		...
		<table class="table table-dark">
			...
			<?php
				foreach ($testii as $testi) {
					echo "<tr>";
					echo "<td><center>" . $testi["nama"] . "</center></td>";
					echo "<td><center>" . $testi["testimoni"] . "</center></td>";
					echo "</tr>";
				}
			?>
		</table>
	...
	<!--<div class="contact-map">
		<h3><center>Find Us On Google</center></h3>
		<p>   </p>
		<p>   </p>

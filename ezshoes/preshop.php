...
<head>
	<title>EZShoes | Preview Shop</title>
...
<div class="banner_top innerpage" id="home">
		...
		<!-- //banner_inner -->
					...
					<!-- product-sec1 -->
					<p><center>Anda harus login atau register terlebih dahulu sebelum bisa berbelanja di EZShoesJKT</center></p>
					<center><a href="login.php">Login Now</a></center>
					<p><center>Belum punya akun ?</center></p>
					...
					<table class="table table-dark">
	                	...
	                	<?php
                    	$sql = mysqli_query($koneksi, "SELECT * FROM barang ORDER BY kode_brg");
